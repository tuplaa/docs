...
| setting             | value                                                                                      |
|---------------------|--------------------------------------------------------------------------------------------|
| Web application URL | [https://tpl.4478.io](https://tpl.4478.io)                                         |
| OpenAPI             | [https://pam.tpl.4478.io/v1/openapi.yaml](https://pam.tpl.4478.io/v1/openapi.yaml) |
| API Base URL        | [https://pam.tpl.4478.io](https://pam.tpl.4478.io)                                 |
...
### 1. Sign-Up
```
dtravin@dt platform % curl -X POST 'https://pam.tpl.4478.io/v1/signup' \
...
dtravin@dt platform % curl -X POST 'https://pam.tpl.4478.io/v1/signin' \
-H 'Content-Type: application/json' \
-d '{
"email": "player2@example.com",
"password": "securePassword123"
...
```
dtravin@dt platform % curl -X GET 'https://pam.tpl.4478.io/v1/players/me' \
